...
local function apply_offsets(mode,offset)
	...
	elseif mode == 4 then
		...
		-- SET LOWER BODY YAW
		ui.set(ref.aa_lby, ui.get(ref.misc_doubletap[CHECKBOX]) and ui.get(ref.misc_doubletap[KEYBIND]) and "sway" or "eye yaw")
	end
end
...
local function run_command()
	...
	jitter_backwards = can_enemy_hit_head(enemyclosesttocrosshair) and local_velocity < 40 and contains(ui.get(menu.aa_jitter), "Full") and not enemies_visible and not local_jumping
